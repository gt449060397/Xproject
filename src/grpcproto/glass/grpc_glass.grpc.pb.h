...
#ifndef GRPC_grpc_5fglass_2eproto__INCLUDED
#define GRPC_grpc_5fglass_2eproto__INCLUDED
...
class grpc_Glass final {
 public:
  static constexpr char const* service_full_name() {
    return "Xproject.grpc_Glass";
  }
  class StubInterface {
   public:
...
#endif  // GRPC_grpc_5fglass_2eproto__INCLUDED
